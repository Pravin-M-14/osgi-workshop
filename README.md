...
| Job | What it does |
|---|---|
| `resolver-tests` | Runs the 65 unit tests. Gates `plan`, because a parser bug wouldn't fail the build — it would quietly build the *wrong subset* and report success. |
...
65 tests, stdlib only. They cover OSGi manifest parsing edge cases (72-byte line
